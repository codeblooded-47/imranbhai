...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <button type="submit"  name="short_details_submitted" class="btn btn-primary" id="short_details_submit" > Submit</button>
<!-- </form>end -->
...
<div id="form_for_update_order_address">
 <div class="form-group">
  ...
  <button type="submit" class="btn btn-primary" id="upate_btn_order_address">Submit</button>
...
<!-- form for order update end -->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary">Add To Delivered</button>
      </div>
    </div>
  </div>
</div>
    ...
    $.ajax({
        ...
        success: function(resp){
            ...
            if(resp.status == "success"){
              ...
              var data = '<div class="card mt-2"><div class="card-header d-flex justify-content-between"> <span id="order_id">'+resp.product_id+'</span>  <button class="btn btn-primary" data-toggle="modal" data-target="#orderupdatemodel" data-order-id="'+resp.product_id+'" id="btn_for_update_order">Update</button></div><div class="card-body"><!-- <h5 class="card-title"></h5> --><p class="card-text"><!--details list  --><ul class="list-group list-group-flush"><li class="list-group-item">Last Updated At : Utterpradesh</li><li class="list-group-item">Destination : '+ resp.destinaton_address+'</li><li class="list-group-item">Intial Address : '+ resp.initial_address+'</li><li class="list-group-item">Cost : '+ resp.estimated_cost +'</li><li class="list-group-item">Email : '+ resp.email+'</li></ul><!-- end --><div class="text-right mt-2"><a href="#" class="btn btn-primary" id="hass">Go somewhere</a></div></div></div>';
